# 🥐 Panadería Web – Sistema de Gestión

Este proyecto es una **página web desarrollada en ASP.NET y Bootstrap** para la gestión de una panadería. 
...
- **ASP.NET** – Framework backend para la lógica del servidor y renderizado de vistas.
- **C#** – Lenguaje de programación del lado del servidor.
- **Bootstrap** – Framework CSS para diseño responsivo y moderno.
- **SQL Server** – Base de datos para almacenar productos, usuarios, etc.
